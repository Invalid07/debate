...
def get_input(state: agent) -> agent:
    ...
    state['topic'] = input("🎯 Enter debate topic: ")
    print("\n" + "="*80)
    print("🤖 Starting Debate - Generating Arguments...")
    print("="*80 + "\n")
    return state
...
def player1_affirmative(state: agent) -> agent:
    ...
    print("✅ PLAYER 1 (AFFIRMATIVE - Supporting the topic)")
    print("-" * 80)
...
def player2_negative(state: agent) -> agent:
    ...
    print("❌ PLAYER 2 (NEGATIVE - Opposing the topic)")
    print("-" * 80)
...
if __name__ == "__main__":
    print("\n" + "="*80)
    print("🎭 AI DEBATE SYSTEM - LLaMA 3 vs LLaMA 3")
    print("="*80 + "\n")
    ...
    # Print final summary
    print("\n" + "="*80)
    print("📊 FINAL DEBATE SUMMARY")
    print("="*80)
    print(f"\n📌 Topic: {result['topic']}\n")

    print("✅ PLAYER 1 (AFFIRMATIVE):")
    print("-" * 80)
